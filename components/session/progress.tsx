...
const steps = [
  { title: 'Listen', description: 'Description for Step 1' },
  { title: 'Read & Repeat', description: 'Description for Step 2' },
  { title: 'Hide & Recall', description: 'Description for Step 3' },
];
